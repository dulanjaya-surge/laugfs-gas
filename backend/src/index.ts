...
import { seedCompany, COMPANY_PUBLIC_ACTIONS } from './seed/company';
import { migrateGlobalLinks } from './seed/links';
...
const globalSeed = {
  ...
  navLinks: [
    ...
    { label: 'MEDIA', href: '/company#films' },
  ],
  socialLinks: [
  ...
  copyright: '© 2026 LAUGFS Gas PLC. All rights reserved.',
  exchangeNote: 'Colombo Stock Exchange — LGL.N0000',
  footerColumns: [
    {
      title: 'INVESTORS',
      links: [
    ...
    },
    {
      ...
      links: [
        ...
        { label: 'Find an agent', href: '/refill#agents' },
...
const homeSections: any[] = [
  {
    ...
    primaryLabel: 'Annual Report 2024/25',
    primaryHref: '/company#recognition',
    secondaryLabel: 'Refill prices',
    secondaryHref: '/refill',
  },
  {
  ...
  },
  {
    ...
    hotlineLabel: 'Safety hotline',
    hotlineHref: 'tel:+94115566222',
    tips: [
  ...
  },
  {
    ...
    linkHref: 'https://www.laugfsmaritime.com',
    vessels: [
  ...
  },
  {
    ...
    linkHref: '/company#films',
    cards: [
      { tag: 'INVESTOR', title: 'Annual Report 2024/25 published', foot: 'PDF', href: '/company#recognition' },
      { tag: 'MEDIA RELEASE', title: 'Latest company announcements and press coverage', foot: 'MEDIA CENTRE', href: '/company#films' },
      { tag: 'CONSUMER', title: 'District-wise domestic refill price list', foot: 'PRICES', href: '/refill' },
    ],
  },
];
...
export default {
  ...
  async bootstrap({ strapi }: { strapi: Core.Strapi }) {
    ...
    try {
      ...
      await migrateGlobalLinks(strapi);
    } catch (err) {
